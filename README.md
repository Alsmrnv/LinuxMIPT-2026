...
2. Идем в `KDIR/boot/`. Так как я предполагаю, что ядро собрано, то ожидаю, что в этой папке уже лежит собранное ядро линукс вместе с конфигурациями. В моем случае это файл `vmlinuz-6.18.8`.
